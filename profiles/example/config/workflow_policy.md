...
- Private GitHub Project node IDs, status option IDs, assignee names, and notification credentials belong in an untracked private config file, `profiles/example/secrets/`, or environment variables.
...
Copy this profile before using CQ for a real company.
